...
const translations = {
    en: {
        ...
        'dashboard.contextTitle': 'Your Bangladesh digital passport',
        'dashboard.contextSubtitle': 'Manage your identity once and explore every Banglade.sh experience from here.',
        'dashboard.statusTitle': 'Account Status',
        'dashboard.statusVerified': 'Email verified',
        'dashboard.statusVerifiedDesc': 'You are ready to use every Banglade.sh service.',
        'dashboard.statusUnverified': 'Email verification pending',
        'dashboard.statusUnverifiedDesc': 'Verify your email to unlock payments and community features.',
        'dashboard.resendVerification': 'Resend verification email',
        'dashboard.servicesTitle': 'Explore Services',
        'dashboard.servicesSubtitle': 'One login unlocks these modules today:',
        'dashboard.servicePostsTitle': 'Posts',
        'dashboard.servicePostsDesc': 'Share updates at posts.banglade.sh and follow your communities.',
        'dashboard.serviceFilesTitle': 'Files',
        'dashboard.serviceFilesDesc': 'Securely store documents and media via files.banglade.sh.',
        'dashboard.serviceWalletTitle': 'Wallet',
        'dashboard.serviceWalletDesc': 'Unified wallet for payments, bills, and loyalty (coming soon).',
        ...
        'editProfile.emailHint': 'Changing your email will require verification',
    ...
    bn: {
        ...
        'dashboard.contextTitle': 'আপনার বাংলাদেশ ডিজিটাল পাসপোর্ট',
        'dashboard.contextSubtitle': 'একটি পরিচয়ে সব Banglade.sh সেবা ব্যবহার করুন।',
        'dashboard.statusTitle': 'অ্যাকাউন্ট অবস্থা',
        'dashboard.statusVerified': 'ইমেইল যাচাই সম্পন্ন',
        'dashboard.statusVerifiedDesc': 'আপনি এখন সব সেবা ব্যবহার করতে পারবেন।',
        'dashboard.statusUnverified': 'ইমেইল যাচাই বাকি',
        'dashboard.statusUnverifiedDesc': 'পেমেন্ট ও কমিউনিটি ফিচার পেতে ইমেইল যাচাই করুন।',
        'dashboard.resendVerification': 'যাচাইকরণ ইমেইল পুনরায় পাঠান',
        'dashboard.servicesTitle': 'সেবাগুলো অন্বেষণ করুন',
        'dashboard.servicesSubtitle': 'একবার লগইনেই এই অভিজ্ঞতাগুলো পাবেন:',
        'dashboard.servicePostsTitle': 'পোস্ট',
        'dashboard.servicePostsDesc': 'posts.banglade.sh এ খবর শেয়ার করুন ও কমিউনিটি অনুসরণ করুন।',
        'dashboard.serviceFilesTitle': 'ফাইল',
        'dashboard.serviceFilesDesc': 'files.banglade.sh এ নিরাপদে ডকুমেন্ট ও মিডিয়া রাখুন।',
        'dashboard.serviceWalletTitle': 'ওয়ালেট',
        'dashboard.serviceWalletDesc': 'একীভূত ওয়ালেট, বিল ও লয়্যালটি (শীঘ্রই আসছে)।',
        ...
        'editProfile.emailPlaceholder': 'you@example.com',
        'editProfile.emailHint': 'ইমেইল পরিবর্তন করলে নতুন করে যাচাই করতে হবে',
